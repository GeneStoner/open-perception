...
function Pair({ bothTranslate, density }: { bothTranslate: boolean; density: number }) {
  return (
    <div className="flex flex-wrap gap-6 justify-center">
      <div className="flex-1 min-w-[280px] max-w-[420px]">
        ...
        <Demo delayedField={1} bothTranslate={bothTranslate} density={density} />
      </div>
      <div className="flex-1 min-w-[280px] max-w-[420px]">
        <p className="text-xs mb-2 text-center" style={{ color: "var(--text-muted)" }}>
          delayed: <span style={{ color: "rgb(90,180,90)" }}>green</span>
        </p>
        <Demo delayedField={0} bothTranslate={bothTranslate} density={density} />
      </div>
    </div>
  );
}
...
function DensitySection({
  ...
  return (
    <section className="mt-12">
      ...
      <Pair bothTranslate={false} density={density} />
      ...
      <Pair bothTranslate={true} density={density} />
    </section>
  );
}
...
export default function Page() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <DensitySection density={4.5} experimentalCondition="173" />
      <DensitySection density={13} experimentalCondition="500" />
    </div>
  );
}
